...
p3 = plot(df_cleaned.sasdate, df_cleaned.TB3MS, label="TB3MS", legend=:none, xlabel="Date", ylabel="TB3MS", title="3-Month Treasury Bill Rate")

# Combine the plots into a 2x1 layout
plot(p1, p2, p3, layout=(3, 1), size=(1000, 1300))

## Obtain the forecast
## The forecast is done using ARX model
